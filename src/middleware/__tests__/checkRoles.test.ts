...
describe("checkRoles", () => {
  it("returns 401 when req.user is missing", () => {
    ...
    checkRoles([RoleType.ADMIN])(req as any, res as any, next);
  ...
  it("returns 403 for invalid user role", () => {
    ...
    checkRoles([RoleType.USER])(req as any, res as any, next);
  ...
  it("allows access when user role meets requirement", () => {
    ...
    checkRoles([RoleType.EDITOR])(req as any, res as any, next);
...
describe("checkOwnership", () => {
  it("allows ADMIN without ownership check", async () => {
    ...
    await checkOwnership(getUserId)(req as any, res as any, next);
  ...
  it("returns 403 when user is not owner", async () => {
    ...
    await checkOwnership(async () => "other-user")(req as any, res as any, next);
  ...
  it("returns 404 when resource owner is not found", async () => {
    ...
    await checkOwnership(async () => undefined)(req as any, res as any, next);
  ...
  it("allows owner access", async () => {
    ...
    await checkOwnership(async () => "1")(req as any, res as any, next);
