...
export interface FillPosNameukrFromArtsResult {
  updatedCount: number;
 ...
 */
export const fillPosNameukrFromArtsUtil =
  async (): Promise<FillPosNameukrFromArtsResult> => {
    ...
    const artikulToNameukr = new Map<string, string>();
