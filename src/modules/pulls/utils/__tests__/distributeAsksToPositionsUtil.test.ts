...
import type { IAsk } from "../../../asks/models/Ask.js";
import type { IPos } from "../../../poses/models/Pos.js";
import { Types } from "mongoose";

const buildAsk = (overrides: Partial<IAsk>): IAsk =>
  ({
...
const buildPosition = (overrides: Partial<IPos>): IPos =>
  ({
    _id: new Types.ObjectId(),
