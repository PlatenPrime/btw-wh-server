...
import {
  buildKonkBtradeComparisonExcel,
  type BuildKonkBtradeComparisonExcelOptions,
} from "../buildKonkBtradeComparisonExcel.js";
...
describe("buildKonkBtradeComparisonExcel", () => {
  it("builds excel with multiple analog blocks stacked", async () => {
    ...
    const options: BuildKonkBtradeComparisonExcelOptions = {
      konk: "air",
      prod: "gemar",
      dateFrom: date1,
      dateTo: date2,
    ...
    expect(fileName).toContain(
      "Порівняльний_зріз_аналогів_та_Btrade_air_gemar_2026-03-01_2026-03-02",
    );
