...
export interface BuildKonkBtradeComparisonExcelOptions {
  dateFrom: Date;
  dateTo: Date;
  konk: string;
  prod: string;
...
export async function buildKonkBtradeComparisonExcel(
  analogs: KonkAnalogInfo[],
  options: BuildKonkBtradeComparisonExcelOptions,
