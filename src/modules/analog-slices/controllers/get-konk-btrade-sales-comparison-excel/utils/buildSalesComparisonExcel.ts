...
import type { KonkAnalogInfo } from "../../get-konk-btrade-comparison-excel/utils/getKonkBtradeComparisonRangeUtil.js";

export interface BuildSalesComparisonExcelOptions {
  dateFrom: Date;
  dateTo: Date;
  konk: string;
  prod: string;
...
export async function buildSalesComparisonExcel(
  ...
  options: BuildSalesComparisonExcelOptions,
