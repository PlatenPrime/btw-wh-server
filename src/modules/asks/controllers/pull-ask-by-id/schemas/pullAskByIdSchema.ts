...
export type PullAskByIdInput = z.infer<typeof pullAskByIdSchema>;
export type PullAskPayload = z.infer<typeof pullDetailsSchema>;
export type PullPalletData = z.infer<typeof palletDataSchema>;
