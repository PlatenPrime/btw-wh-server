...
describe("getSharikData", () => {
  ...
  describe("Обработка ошибок", () => {
    it("должен выбрасывать ошибку при ошибке axios", async () => {
      ...
      await expect(getSharikData("test")).rejects.toThrow(
        "Failed to fetch data from sharik.ua: Network error"
      );
    });
    ...
    it("должен выбрасывать ошибку при неизвестной ошибке", async () => {
      ...
      await expect(getSharikData("test")).rejects.toThrow(
        "Failed to fetch data from sharik.ua: Unknown error"
      );
    });
