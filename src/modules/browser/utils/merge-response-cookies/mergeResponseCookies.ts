export function pickHeaderCaseInsensitive(
...
export function parseSetCookieHeader(setCookie: unknown): string[] {
...
export function mergeCookies(existingCookieHeader: string, setCookie: unknown): string {
