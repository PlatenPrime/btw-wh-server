...
Документация для фронтенда по эндпоинту скачивания Excel-отчёта сравнения срезов аналога (конкурент) и Btrade за период. Отчёты по **продажам и выручке** (а не по остаткам) — [sales-comparison-excel.md](./sales-comparison-excel.md).
