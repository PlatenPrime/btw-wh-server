...
**410** `EXCEL_JOBS_MIGRATED`, kind `grabo-skus`. Выгрузка: [excel-jobs](excel-jobs.md). Params: `{}`.

Колонки готового файла (украинские подписи, без `_id`/`__v`): `ID`, `Назва`, `URL`, `Новинка`, `Колір`, `Розмір`, `Матеріал`, `Газ`, `Мова`, `Об'єм газу`, `Теги`, `Зображення`, `На сайті`, `Остання поява`, `Створено`, `Оновлено`. `tags` и `images` — строки через `"; "`. Даты ISO-8601. Boolean `true`/`false`. Имя файла: `grabo-catalog-YYYY-MM-DD.xlsx` (календарный день Киева).
