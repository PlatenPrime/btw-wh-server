...
- **ADMIN** - расширенный уровень доступа. Позволяет создавать, обновлять и удалять данные в большинстве модулей.
- **PRIME** - максимальный уровень доступа. Позволяет выполнять критические операции, такие как удаление рядов и паллет.
