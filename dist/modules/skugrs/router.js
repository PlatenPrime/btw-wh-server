...
const router = Router();
router.get("/", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(getAllSkugrsController));
router.get("/id/:id", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(getSkugrByIdController));
