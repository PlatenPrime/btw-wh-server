...
import { createKaskController, deleteKaskById, getKaskById, getKasksByDate, updateKaskById, } from "./controllers/index.js";
const router = Router();
router.post("/", checkAuth, checkRoles([RoleType.USER]), asyncHandler(createKaskController));
