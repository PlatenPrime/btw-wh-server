...
describe("getSharteStockData", () => {
    ...
    `;
        ...
        const result = await getSharteStockData("999", "https://sharte.net/catalog/product/999/");
        expect(result).toEqual({
            id: "999",
            name: "",
            stock: 0,
        ...
        expect(browserGet).toHaveBeenNthCalledWith(1, "https://sharte.net/ajax.php?act=addCart&id=999&q=1&site_id=s1");
        expect(browserGet).toHaveBeenNthCalledWith(2, "https://sharte.net/catalog/product/999/");
    });
