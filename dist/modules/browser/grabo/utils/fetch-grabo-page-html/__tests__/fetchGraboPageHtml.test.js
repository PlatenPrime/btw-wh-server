...
import { GRABO_FETCH_MAX_ATTEMPTS, GRABO_FETCH_RETRY_WAIT_MS, fetchGraboPageHtml, } from "../fetchGraboPageHtml.js";
...
const TIMEOUT = new Error("Browser GET failed (ETIMEDOUT): https://www.grabo-balloons.com/en/hearts/page-4 — connect ETIMEDOUT 77.89.18.150:443");
describe("fetchGraboPageHtml", () => {
    ...
    it("throws after three transient failures", async () => {
        ...
        expect(mockLogger.warn).toHaveBeenCalledWith(expect.objectContaining({ attempt: 3, url: URL }), "grabo fetch retry exhausted");
    });
