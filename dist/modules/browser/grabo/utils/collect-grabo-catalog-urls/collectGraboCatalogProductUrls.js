 ...
 */
export async function collectGraboCatalogProductUrls(options) {
    ...
    log.info({ sitemapUrl: GRABO_SITEMAP_URL, categoryCount: categoryUrls.length }, "grabo catalog sitemap parsed");
    ...
    for (let i = 0; i < categoryUrls.length; i++) {
        ...
        const index = i + 1;
        log.info({ index, total: categoryUrls.length, categoryUrl }, "grabo catalog category start");
        try {
