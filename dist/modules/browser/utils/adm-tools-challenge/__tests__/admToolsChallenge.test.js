...
import { evalAdmToolsAckExpression, extractAdmToolsAckExpression, isAdmToolsChallengeHtml, resolveAdmToolsAckFromHtml, } from "../admToolsChallenge.js";
...
describe("extractAdmToolsAckExpression", () => {
    it("достаёт выражение из form.append", () => {
        expect(extractAdmToolsAckExpression(SAMPLE_CHALLENGE_HTML)).toBe("6-27+26+56");
    });
...
describe("resolveAdmToolsAckFromHtml", () => {
    ...
    it("кидает без выражения", () => {
        expect(() => resolveAdmToolsAckFromHtml("<html>adm.tools ___ack</html>")).toThrow(/missing ___ack/);
    });
});
