...
import { fetchGroupProductsByKonkName, UnsupportedKonkForGroupProductsError, } from "../fetchGroupProductsByKonkName.js";
...
describe("fetchGroupProductsByKonkName", () => {
    ...
    it("throws UnsupportedKonkForGroupProductsError for unknown konk", async () => {
        await expect(fetchGroupProductsByKonkName("unknown-shop", {
