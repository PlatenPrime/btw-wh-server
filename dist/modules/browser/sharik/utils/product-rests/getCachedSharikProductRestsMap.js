import { getProductRestsSeedArtikul, SHARIK_PRODUCT_RESTS_CACHE_TTL_MS, } from "./constants.js";
import { fetchSharikProductRestsMap } from "./fetchSharikProductRestsMap.js";
let cache = null;
function isCacheFresh(entry, seedArtikul, now) {
    return (entry.seedArtikul === seedArtikul &&
 ...
 */
export async function getCachedSharikProductRestsMap(seedArtikul = getProductRestsSeedArtikul()) {
    const now = Date.now();
