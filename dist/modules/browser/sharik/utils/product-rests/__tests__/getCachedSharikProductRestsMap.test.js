...
import { clearSharikProductRestsCache, getCachedSharikProductRestsMap, } from "../getCachedSharikProductRestsMap.js";
...
describe("getCachedSharikProductRestsMap", () => {
    ...
    it("refetches after TTL expires", async () => {
        ...
        vi.mocked(browserGet).mockResolvedValue("<pre>1501-3445 = 1; 2; 10.00</pre>");
    ...
    it("dedupes parallel miss into one fetch", async () => {
        let resolveHtml;
        vi.mocked(browserGet).mockImplementation(() => new Promise((resolve) => {
            resolveHtml = resolve;
        }));
