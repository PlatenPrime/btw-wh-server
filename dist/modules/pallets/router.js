...
router.post("/", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(createPallet));
router.post("/move-poses", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(movePalletPoses));
