...
describe("completeAskById Controller", () => {
    let mockRequest;
    let responseJson;
    let responseStatus;
    let res;
    ...
    it("should complete ask with valid solverId and add completion action", async () => {
        // Arrange
        mockRequest = {
        ...
        // Act
        await completeAskById(mockRequest, res);
        // Assert
        ...
        expect(responseJson.actions[1]).toBe("15.01.2024 10:30 Solver User: ВИКОНАВ запит");
    });
    ...
    it("should handle ask with existing actions and add completion action", async () => {
    ...
    it("should handle ask with empty actions array", async () => {
        ...
        expect(responseJson.actions[0]).toBe("15.01.2024 10:30 Solver User: ВИКОНАВ запит");
    });
    it("should preserve all existing ask fields during completion", async () => {
        // Arrange
        mockRequest = {
            params: { id: testAsk._id.toString() },
            body: {
