...
describe("runCompensatingSlicesForKonk", () => {
    ...
    it("normalizes konkName and runs analog+sku for today", async () => {
        ...
        expect(runCompensatingAnalogSlices).toHaveBeenCalledWith(new Date("2026-07-14T00:00:00.000Z"), { konkName: "air" });
        expect(runCompensatingSkuSlices).toHaveBeenCalledWith(new Date("2026-07-14T00:00:00.000Z"), { konkName: "air" });
    });
});
