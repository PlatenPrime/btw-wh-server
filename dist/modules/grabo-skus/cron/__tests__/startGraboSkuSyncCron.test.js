...
import { clearGraboSkuSyncForTests, tryAcquireGraboSkuSync, } from "../../utils/graboSkuSyncLock.js";
import { runGraboSkuSyncUtil } from "../../utils/runGraboSkuSyncUtil.js";
import { GRABO_SKU_SYNC_CRON_EXPR, GRABO_SKU_SYNC_CRON_TZ, startGraboSkuSyncCron, } from "../startGraboSkuSyncCron.js";
describe("startGraboSkuSyncCron", () => {
    ...
    it("creates CronJob Saturday 04:00 Kyiv", () => {
        ...
        expect(mockedCronJob).toHaveBeenCalledWith(GRABO_SKU_SYNC_CRON_EXPR, expect.any(Function), null, true, GRABO_SKU_SYNC_CRON_TZ);
