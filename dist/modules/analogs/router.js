...
router.get("/", checkAuth, checkRoles([RoleType.USER]), asyncHandler(getAnalogsController));
router.post("/", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(createAnalogController));
router.patch("/id/:id", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(updateAnalogByIdController));
router.delete("/id/:id", checkAuth, checkRoles([RoleType.PRIME]), asyncHandler(deleteAnalogByIdController));
