...
import { DEFICIT_REPORT_CRON_EXPR, DEFICIT_REPORT_CRON_TZ, } from "../constants/deficitReportCron.js";
import { releaseDeficitReport, tryAcquireDeficitReport, } from "../utils/deficitReportLock.js";
 ...
 */
export function startDeficitReportCron() {
    const job = new CronJob(DEFICIT_REPORT_CRON_EXPR, async () => {
    ...
    }, null, true, DEFICIT_REPORT_CRON_TZ);
    log.info({ schedule: DEFICIT_REPORT_CRON_EXPR, timezone: DEFICIT_REPORT_CRON_TZ }, "cron started");
    return job;
}
