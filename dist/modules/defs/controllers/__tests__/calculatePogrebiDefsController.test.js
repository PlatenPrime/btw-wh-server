...
describe("calculatePogrebiDefsController", () => {
    ...
    it("500 when calculation throws", async () => {
        ...
        await calculatePogrebiDefsController(mockReq, mockRes);
        expect(logModuleError).toHaveBeenCalledWith("defs", error, "Error in calculatePogrebiDefsController:");
    ...
    it("500 with Unknown error for non-Error rejection", async () => {
        ...
        await calculatePogrebiDefsController(mockReq, mockRes);
        expect(logModuleError).toHaveBeenCalledWith("defs", "String error", "Error in calculatePogrebiDefsController:");
        expect(mockStatus).toHaveBeenCalledWith(500);
        expect(mockJson).toHaveBeenCalledWith({
            success: false,
            message: "Failed to calculate and save deficits",
