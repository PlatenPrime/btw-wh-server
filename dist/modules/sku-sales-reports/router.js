...
import { getKonkProdSkugrGroupsSalesController, getSkugrDailySummaryController, getSkugrSkusSalesController, getSkuSalesByDateController, getSkuSalesRangeController, } from "./controllers/index.js";
const router = Router();
...
router.get("/skugr/:skugrId/skus-sales", checkAuth, checkRoles([RoleType.ADMIN]), asyncHandler(getSkugrSkusSalesController));
