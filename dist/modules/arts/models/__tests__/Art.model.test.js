...
describe("Art Model", () => {
    ...
    describe("btradeStock Subdocument", () => {
        ...
        it("should use current date when btradeStock date is not provided", async () => {
            ...
            // Assert
            expect(savedArt.btradeStock?.date).toBeInstanceOf(Date);
            expect(savedArt.btradeStock?.date.getTime()).toBeGreaterThan(Date.now() - 1000); // Within 1 second
        });
    ...
    describe("Timestamps", () => {
        ...
        it("should update updatedAt when document is modified", async () => {
            ...
            // Assert
            expect(updatedArt.updatedAt.getTime()).toBeGreaterThan(originalUpdatedAt.getTime());
    ...
    describe("Update Operations", () => {
        it("should update art by artikul", async () => {
            ...
            // Act
            const result = await Art.updateOne({ artikul: "UPDATE001" }, { $set: { nameukr: "Updated Name", limit: 500 } });
            // Assert
        ...
        it("should update btradeStock", async () => {
            ...
            // Act
            const result = await Art.updateOne({ artikul: "BTradeUpdate001" }, { $set: { "btradeStock.value": 200 } });
            // Assert
            expect(result.modifiedCount).toBe(1);
