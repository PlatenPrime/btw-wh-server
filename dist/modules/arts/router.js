...
router.get("/btrade/:artikul", checkAuth, checkRoles([RoleType.USER]), getBtradeArtInfo);
...
router.patch("/:artikul/btrade-stock", checkAuth, checkRoles([RoleType.ADMIN]), updateBtradeStock);
