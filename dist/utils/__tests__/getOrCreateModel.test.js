...
describe("getOrCreateModel", () => {
    ...
    it("registers a model on first call", () => {
        ...
        const Model = getOrCreateModel("TestGetOrCreateModel", schema);
    ...
    it("returns existing model without OverwriteModelError", () => {
        const schema = new Schema({ name: String });
        const first = getOrCreateModel("TestGetOrCreateModel", schema);
        const second = getOrCreateModel("TestGetOrCreateModel", schema);
